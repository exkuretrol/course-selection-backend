...
Department = {'管理學院':'1152545657','國際企業學系':'57','國企系':'57','國企':'57','風險管理與保險學系':'56','風保系':'56','風保':'56',
                '會計學系':'52','會計系':'52','會計':'52','企業管理學系':'11','企管系':'11','企管':'11','財務金融學系':'54','財金系':'54',
                '財金':'54','資訊學院':'0513163637','資訊管理學系':'13','資管系':'13','資管':'13','資訊傳播工程學系':'16','資傳系':'16',
                '資傳':'16','資訊工程學系':'36','資工系':'36','資工':'36','電腦與通訊工程學系':'05','電通系':'05','電通':'05',
                '電子工程學系':'37','電子系':'37','電工系':'37','電子':'37','電工':'37','傳播學院':'26313233','廣播電視學系':'32','廣電系':'32',
                '廣電':'32','新聞學系':'33','新聞系':'33','新聞':'33','廣告暨策略行銷學系':'26','廣銷系':'26','廣銷':'26','新媒體暨傳播管理學系':'31',
                '新傳系':'31','新傳':'31','法律學院':'4165','法律學系':'41','法律系':'41','法律':'41','財金法律系':'65','財法系':'65','財法':'65',
                '觀光學院':'141819','觀光事業學系':'14','觀光系':'14','觀光':'14','休閒遊憩管理學系':'18','休憩系':'18','休憩':'18',
                '餐旅管理學系':'19','餐旅系':'19','餐旅':'19','教育暨應用語文學院':'4243444583','應用中國文學系':'43','應中系':'43','應中':'43',
                '應用英語學系':'42','應英系':'42','應英':'42','應用日語學系':'44','應日系':'44','應日':'44','教育研究所':'83','華語文教學學系':'45',
                '華教系':'45','華教':'45','設計學院':'040921232450','商業設計學系':'21','商設系':'21','商設':'21','商品設計學系':'23','品設系':'23',
                '品設':'23','數位媒體設計學系':'09','數媒系':'09','數媒':'09','都市規劃與防災學系':'04','都防系':'04','都防':'04','建築學系':'24',
                '建築系':'24','建築':'24','動漫文創設計學士學位學程':'50','動漫學程':'50','社會科學院':'083868','公共事務與行政管理學系':'68',
                '公事系':'68','公事':'68','諮商與工商心理學系':'08','心理系':'08','心理':'08','犯罪防治學系':'38','犯防系':'38','犯防':'38',
                '健康科技學院':'394067','生物科技學系':'39','生科系':'39','生科':'39','醫療資訊與管理學系':'40','醫管系':'40','醫管':'40',
                '生物醫學工程學系':'67','醫工系':'67','醫工':'67','國際學院':'252747485991','國際事務與外交學士學位學程':'59',
                '國際企業與貿易學士學位學程':'91','新聞與大眾傳播學士學位學程':'27','時尚與創新管理學士學位學程':'25','旅遊與觀光學士學位學程':'48',
                '資訊科技應用與管理學士學位學程':'47','金融科技學院':'172246','經濟與金融學系':'22','經濟系':'22','經濟':'22','應用統計與資料科學學系':'17',
                '統資系':'17','統資':'17','金融科技應用學士':'46','金科系':'46','金科':'46'
            }
...
def ner_query(text: List[NerToken]):
    ...
    res = dict(people=people, category=category, grade=grade, department=department, time_lesson=time_lesson, time_week=time_week, campus=campus, subject=subject, curriculum=curriculum, credit=credit, semester=semester, education=education, internship=internship, graduate=graduate, stuclass=Class)
    ...
    for k, v in res.items():
        ...
        #     for search in v:
        #          cond.append("`上課時間` = '%s'"%(search))
        if k == 'time_week' and len(v) > 0:
            l = []
            for search in v:
                l.append(f"left(`上課時間`, 1) = '{search}'")
            cond.append('(' + ' or '.join(l) + ')')
        if k == 'people' and len(v) > 0:
            for search in v:
                cond.append(f"`老師注音` like '{search}%'")
        if k == 'department' and len(v) > 0:
            for search in v:
                cond.append("`班級代號` = '%s'"%(search))
